...
describe "clients_companies/edit" do
  before(:each) do
  ...
  it "renders the edit clients_company form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form[action=?][method=?]", clients_company_path(@clients_company), "post" do
