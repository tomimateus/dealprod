...
class BranchesControllerTest < ActionController::TestCase
  ...
  test "should create branch" do
    assert_difference('Branch.count') do
      post :create, branch: { address_id: @branch.address_id, company_id: @branch.company_id, name: @branch.name }
    end
  ...
  test "should update branch" do
    put :update, id: @branch, branch: { address_id: @branch.address_id, company_id: @branch.company_id, name: @branch.name }
    assert_redirected_to branch_path(assigns(:branch))
  end
